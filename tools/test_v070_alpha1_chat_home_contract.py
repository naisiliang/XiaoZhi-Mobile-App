...
require(history_on_create, "repository.loadHistoryPage()", "bounded history repository loading")
forbid(history_on_create, "repository.loadHistory()", "unbounded history repository loading")
