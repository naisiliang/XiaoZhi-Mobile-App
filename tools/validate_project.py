...
check('version 0.6.1', 'versionCode = 8' in build and 'versionName = "0.6.1"' in build)
...
check('workflow produces v0.6.1 apk', 'XiaoZhi-Mobile-v0.6.1-debug.apk' in workflow)
